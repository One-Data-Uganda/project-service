...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            "has_board", sa.Boolean(), server_default=sa.text("false"), nullable=True
        ),
        ...
        sa.Column(
            "nin_validate", sa.Boolean(), server_default=sa.text("false"), nullable=True
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_table(
    ...
    op.create_table(
        ...
        sa.Column(
            "data_shareable_public",
            sa.Boolean(),
            server_default=sa.text("false"),
            nullable=True,
        ),
        sa.Column(
            "data_shareable_local",
            sa.Boolean(),
            server_default=sa.text("false"),
            nullable=True,
        ),
        sa.ForeignKeyConstraint(
            ["capacity_id"], ["capacity.id"], onupdate="CASCADE", ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(
            ["energy_resource_id"],
            ["energy_resource.id"],
        ...
        sa.ForeignKeyConstraint(
            ["off_taker_id"], ["off_taker.id"], onupdate="CASCADE", ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(
            ["ppa_status_grid_id"],
            ["ppa_status.id"],
        ...
        sa.ForeignKeyConstraint(
            ["ppa_status_id"], ["ppa_status.id"], onupdate="CASCADE", ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(
            ["technology_id"], ["technology.id"], onupdate="CASCADE", ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(
            ["unit_id"], ["unit.id"], onupdate="CASCADE", ondelete="CASCADE"
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["status_id"], ["status.id"], onupdate="CASCADE", ondelete="CASCADE"
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_table(
    ...
    op.create_table(
        ...
        sa.Column("sponsor_type_id", postgresql.UUID(as_uuid=True), nullable=True),
        sa.ForeignKeyConstraint(
            ["sponsor_id"], ["sponsor.id"], onupdate="CASCADE", ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(
            ["sponsor_type_id"],
            ["sponsor_type.id"],
    ...
    op.create_table(
        ...
        sa.Column(
            "is_primary", sa.Boolean(), server_default=sa.text("false"), nullable=True
        ),
        sa.ForeignKeyConstraint(
            ["sponsor_id"], ["sponsor.id"], onupdate="CASCADE", ondelete="CASCADE"
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["power_id"], ["power.id"], onupdate="CASCADE", ondelete="CASCADE"
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_table(
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["type_id"], ["ptype.id"], onupdate="CASCADE", ondelete="CASCADE"
        ),
        sa.PrimaryKeyConstraint("id"),
    )
