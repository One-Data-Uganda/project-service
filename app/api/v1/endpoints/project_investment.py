...
async def create_project_investment(
    ...
    try:
        ...
        raise HTTPException(
            status_code=400, detail="Project Investment with this ID already exists"
        )
...
async def get_project_investment(
    ...
    if not r:
        raise HTTPException(status_code=401, detail="Project Investment not found")
...
async def update_project_investment(
    ...
    if not project_investment:
        raise HTTPException(status_code=404, detail="Project Investment not found")
