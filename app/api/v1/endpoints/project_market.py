...
async def create_project_market(
    ...
    try:
        ...
        raise HTTPException(
            status_code=400, detail="Project Market with this ID already exists"
        )
...
async def get_project_market(
    ...
    if not r:
        raise HTTPException(status_code=401, detail="Project Market not found")
...
async def update_project_market(
    ...
    if not project_market:
        raise HTTPException(status_code=404, detail="Project Market not found")
