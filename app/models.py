...
class ProjectData(Base, SerializerMixin):
    ...
    tail_type = Column(Text)
    tail_length = Column(Float)
    tail_width = Column(Float)
...
class RiskManagement(Base, SerializerMixin):
    ...
    guarantee_amount_mobilized = Column(Float)
